        ...
        const panelHtml = `
            <div id="admin-panel" class="dk-modal-container fixed top-4 right-4 z-50 bg-white rounded-2xl shadow-2xl w-80 overflow-hidden">
                ...
                <div class="p-4 space-y-3">
                    ...
                    <button onclick="alert('Usa el panel admin local (local-admin.html) en tu PC para editar productos. Luego ejecuta push.bat para subir a GitHub.')" class="w-full flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white p-3.5 rounded-xl text-sm font-semibold transition-all group">
